...
func TestBuildResponsesFinalTextWithCitations(t *testing.T) {
	segments := []respSearchSegment{
		{query: "q1", results: []search.SearchResult{{Title: "T1", URL: "https://1.example"}, {Title: "T2", URL: "https://2.example"}}},
		{query: "q2", results: []search.SearchResult{{Title: "T1", URL: "https://1.example"}, {Title: "T3", URL: "https://3.example"}}},
	}
...
func TestHandleResponsesWebSearchLoop(t *testing.T) {
	...
	search.RegisterProviderForTest("searxng", func(_ *search.ProviderConfig, c *http.Client) search.SearchProvider {
		return &fakeStaticProvider{results: []search.SearchResult{{Title: "Go 1.24 Release", URL: "https://go.example/1.24"}}}
	})
...
func TestHandleResponsesWebSearchLoopOpenAI(t *testing.T) {
	...
	search.RegisterProviderForTest("searxng", func(_ *search.ProviderConfig, c *http.Client) search.SearchProvider {
		return &fakeStaticProvider{results: []search.SearchResult{{Title: "Rust 1.85", URL: "https://rust.example/1.85"}}}
	})
	search.Global.Reload(&search.Config{
		Active: "searxng", MaxPerTurn: 3, DefaultNumResults: 3,
		Providers: map[string]*search.ProviderConfig{"searxng": {Enabled: true}},
