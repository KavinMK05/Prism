...
func (pr *ProviderRouter) HandleOpenAIChatCompletions(w http.ResponseWriter, r *http.Request) {
	...
	stats.Global.StartRequest(openAIReq.Model, rp.ProviderID, client)
...
func (pr *ProviderRouter) handleOpenAIInboundToOllama(w http.ResponseWriter, r *http.Request, openAIReq *OpenAIChatRequest, rp *config.ResolvedProvider) {
	reqStart := time.Now()
...
func (pr *ProviderRouter) handleOpenAIInboundToOpenAI(w http.ResponseWriter, r *http.Request, openAIReq *OpenAIChatRequest, rp *config.ResolvedProvider) {
	reqStart := time.Now()
...
func (pr *ProviderRouter) HandleModels(w http.ResponseWriter, r *http.Request) {
	...
	buildModelObj := func(id string, entry config.ModelEntry, providerName string) map[string]interface{} {
