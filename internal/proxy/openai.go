...
func (pr *ProviderRouter) HandleOpenAIMessages(w http.ResponseWriter, r *http.Request, anthroReq *AnthropicRequest, rp *config.ResolvedProvider) {
...
func (pr *ProviderRouter) handleOpenAINonStreaming(w http.ResponseWriter, r *http.Request, openAIReq *OpenAIChatRequest, anthroReq *AnthropicRequest, rp *config.ResolvedProvider) {
	reqStart := time.Now()
