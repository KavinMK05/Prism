...
func newSearXNGProvider(pc *ProviderConfig, client *http.Client) SearchProvider {
...
func newExaProvider(pc *ProviderConfig, client *http.Client) SearchProvider {
...
func (p *exaSearchProvider) Search(ctx context.Context, q SearchQuery) ([]SearchResult, error) {
	...
	for _, r := range raw.Results {
		out = append(out, SearchResult{
			...
			Score:      r.Score,
			Snippet:    util.JoinStrings(r.Highlights),
		})
	}
	return out, nil
}
...
func newTavilyProvider(pc *ProviderConfig, client *http.Client) SearchProvider {
...
func newBraveProvider(pc *ProviderConfig, client *http.Client) SearchProvider {
...
func newSerperProvider(pc *ProviderConfig, client *http.Client) SearchProvider {
